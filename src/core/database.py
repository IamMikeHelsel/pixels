...
class PhotoDatabase:
    ...
    def add_folder(self, path: str, name: str = None, parent_id: int = None, is_monitored: bool = False) -> int:
        ...
        cursor.execute(
            '''
            INSERT
            OR IGNORE INTO folders (path, name, parent_id, date_added, date_scanned, is_monitored)
